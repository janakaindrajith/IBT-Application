<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="IBT_Records_Suppress_Confirm.aspx.cs" Inherits="BranchMIS.IBT.IBT_Records_Suppress_Confirm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <form runat="server">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-header">
                    <h3>Suppress Records Confirm</h3>
                </div>
            </div>
        </div>
        ...
        <div class="well well-lg">
            <div class="row">
                <div class="col-md-5">
                    <h4>Transations (6 months earlier from today)</h4>

                </div>
                <div class="col-md-1">
                    <asp:Button ID="btn_getData" runat="server" Width="150px" Height ="50px" Text="GET" OnClick="btn_getData_Click" CssClass="btn btn-success" />
                </div>
            </div>
        </div>

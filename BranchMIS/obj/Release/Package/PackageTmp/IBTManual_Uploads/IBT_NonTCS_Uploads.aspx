<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="IBT_NonTCS_Uploads.aspx.cs" Inherits="BranchMIS.IBTManual_Uploads.IBT_NonTCS_Uploads" %>
    ...
    <form runat="server">
       ...
       <div class="row" runat="server">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-header">
                    <h3>Life / NonTCS - Receipt Print</h3>
                </div>
            </div>
            <%--<div class="col-md-4">.col-md-4</div>--%>
        </div>

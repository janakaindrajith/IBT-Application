<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="IBT_Records_Suppress_Approve.aspx.cs" Inherits="BranchMIS.IBT.IBT_Records_Suppress_Approve" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-header">
                    <h3>Suppress Records Approve</h3>
                </div>
            </div>
        </div>
